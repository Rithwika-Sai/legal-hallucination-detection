# =========================================================
# FINAL TINYLLAMA + QAFACTEVAL + INLEGALBERT
# LEGAL HALLUCINATION DETECTION PIPELINE
# =========================================================
#
# FEATURES:
# ✅ TinyLlama Legal Summarization
# ✅ QAFACTEVAL-style Verification
# ✅ Rule-based Legal Question Generation
# ✅ InLegalBERT Semantic Similarity
...
generated_summary = summary_output[0]["generated_text"]
...
def generate_question(sentence):
    ...
    elif "jurisdiction" in sentence_lower:
        return "What objection was raised?"
...
for idx, sent in enumerate(summary_sentences):
    ...
    # =====================================================
    # SEMANTIC COMPARISON USING INLEGALBERT
    # =====================================================
...
with open(
    "tinyllama_qafacteval_results.txt",
    "w",
    encoding="utf-8"
) as file:
...
print("\nResults saved to tinyllama_qafacteval_results.txt")